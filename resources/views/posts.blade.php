...
@endif
    <div class="card-body text-center">
      ...
      <p>By. <a href="/posts?user={{ $posts[0]->user->username }}">{{ $posts[0]->user->name }}</a> in <a href="/posts?category={{ $posts[0]->category->slug }}"> {{ $posts[0]->category->name }}</a> {{ $posts[0]->created_at->diffForHumans() }}</p>
      </small>
        ...
        <div class="col-md-4 mb-3">
            ...
            @endif
                ...
                <div class="card-body">
                  ...
                  <p>
                    <small class="text-muted">
                        <p>By. <a href="/posts?user={{ $post->user->username }}">{{ $post->user->name }}</a> {{ $post->created_at->diffForHumans() }}</p>
                        </small>
                  </p>
